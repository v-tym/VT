(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AboutMeComponent = /** @class */ (function () {
                ...
                AboutMeComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.ls.langClick.subscribe(function (m) { return _this.ln = m; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ExperienceImgComponent = /** @class */ (function () {
                function ExperienceImgComponent(ls, ex) {
                    this.ls = ls;
                    this.ex = ex;
                    this.imgInfo = [];
                    this.clicks = 1;
                ...
                ExperienceImgComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.imgWay = "./img/" + this.id + "/" + this.clicks + ".JPG";
                    this.ln = this.ls._lang;
                    this.ls.langClick.subscribe(function (m) { return _this.ln = m; });
                    this.ex.getImgInfo().subscribe(function (_imgInfo) {
                        _this.imgInfo = _imgInfo;
                        console.log(_this.imgInfo);
                    });
                };
                ExperienceImgComponent.prototype.nextImg = function () {
                ...
                ;
                ExperienceImgComponent.prototype.prevImg = function () {
                    if (this.clicks >= 2) {
                        this.clicks--;
                    }
                    else {
                ...
                ;
                ExperienceImgComponent.prototype.labelImg = function (x) {
                    this.clicks = x;
                };
                return ExperienceImgComponent;
            }());
            ExperienceImgComponent.ctorParameters = function () { return [
                { type: src_app_services_lang_service__WEBPACK_IMPORTED_MODULE_2__["LangService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ResumeComponent = /** @class */ (function () {
                function ResumeComponent(ex, ls, sb, sk) {
                    this.ex = ex;
                    this.ls = ls;
                    this.sb = sb;
                    this.sk = sk;
                ...
                ResumeComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.ex.getExperince().subscribe(function (_experience) {
                        _this.experience = _experience;
                    });
                    console.log(this.experience);
                    this.ln = this.ls._lang;
                    this.ls.langClick.subscribe(function (m) { return _this.ln = m; });
                    this.sb.change_a1.subscribe(function (x1) { return _this.a1 = x1; });
                    this.sb.change_a2.subscribe(function (x2) { return _this.a2 = x2; });
                    this.sb.change_a3.subscribe(function (x3) { return _this.a3 = x3; });
                    this.sb.change_a4.subscribe(function (x4) { return _this.a4 = x4; });
                    this.sb.change_a5.subscribe(function (x5) { return _this.a5 = x5; });
                    this.sb.change_a6.subscribe(function (x6) { return _this.a6 = x6; });
                    this.sk.getSkils().subscribe(function (s) { _this.skilsEng = s; });
                    this.sk.getSkilsProg().subscribe(function (s) { _this.skilsProg = s; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppOboutMeComponent = /** @class */ (function () {
                function AppOboutMeComponent(langService, meta, title) {
                    this.langService = langService;
                    this.meta = meta;
                    this.title = title;
                }
                AppOboutMeComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._lang = this.langService._lang;
                    this.langService.langClick.subscribe(function (ln) { _this._lang = ln; });
                    if (this._lang == "RU") {
                ...
                return AppOboutMeComponent;
            }());
            AppOboutMeComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SidebarComponent = /** @class */ (function () {
                function SidebarComponent(sidebar, ls) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChildComponent = /** @class */ (function () {
                ...
                ChildComponent.prototype.ngOnInit = function () {
                    ...
                    this.ln.langClick.subscribe(function (ln) { _this._ln = ln; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainComponent = /** @class */ (function () {
                function MainComponent(langService, meta, title) {
                    this.langService = langService;
                    this.meta = meta;
                    this.title = title;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactsComponent = /** @class */ (function () {
                function ContactsComponent(langService, meta, title) {
                    this.langService = langService;
                    this.meta = meta;
                    this.title = title;
                    this.color = "red";
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormComponent = /** @class */ (function () {
                function FormComponent(fS, ln, http) {
                    this.fS = fS;
                    this.ln = ln;
                    this.http = http;
                ...
                FormComponent.prototype.postMail = function (form) {
                    var _this = this;
                    var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpRequest"]('POST', 'mail.php', form, {
                        reportProgress: true,
                    });
                    this.http.request(req).subscribe(function (event) {
                        ...
                        if (event.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpEventType"].UploadProgress) {
                            ...
                            _this.percentDone2 = Math.round(100 * event.loaded / event.total) + 5;
                        }
                        if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpResponse"]) {
                            _this.error = true;
                            _this.status1 = "Ваше письмо отправленно!";
                            _this.status2 = "Ваш лист відправлений!";
                            _this.status3 = "Your letter has been sent!";
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_lang_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/lang.service */ "./src/app/services/lang.service.ts");
            /* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
            var KmdComponent = /** @class */ (function () {
                function KmdComponent(langService, meta, title) {
                    this.langService = langService;
                    this.meta = meta;
                    this.title = title;
                    meta.addTags([
                ...
                KmdComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._lang = this.langService._lang;
                    this.langService.langClick.subscribe(function (ln) { _this._lang = ln; });
                    if (this._lang == "UA") {
            ...
            KmdComponent.ctorParameters = function () { return [
                { type: _services_lang_service__WEBPACK_IMPORTED_MODULE_2__["LangService"] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["Meta"] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["Title"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LangComponent = /** @class */ (function () {
                function LangComponent(langService, router) {
                    this.langService = langService;
                    this.router = router;
                    this.languages = [
                        "UA",
                ...
                LangComponent.prototype.radioClick = function (lang) {
                    var _this = this;
                    ...
                    this.router.navigateByUrl('/', { skipLocationChange: true }).then(function () { return _this.router.navigate([changeUrl]); });
                };
                return LangComponent;
            }());
            LangComponent.ctorParameters = function () { return [
                { type: _services_lang_service__WEBPACK_IMPORTED_MODULE_2__["LangService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PortfolioComponent = /** @class */ (function () {
                function PortfolioComponent(langService, meta, title) {
                    this.langService = langService;
                    this.meta = meta;
                    this.title = title;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ExperienceService = /** @class */ (function () {
                ...
                ExperienceService.prototype.getExperince = function () {
                    return this.http.get('assets/getAboutMe.JSON');
                };
                ExperienceService.prototype.getImgInfo = function () {
                    return this.http.get('assets/imgInfo.JSON');
                };
                return ExperienceService;
            }());
            ExperienceService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FromService = /** @class */ (function () {
                function FromService(http) {
                    this.http = http;
                }
                FromService.prototype.postMail = function (form) {
                    var _this = this;
                    var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', 'mail.php', form, {
                        reportProgress: true,
                    });
                    this.http.request(req).subscribe(function (event) {
                        // Via this API, you get access to the raw event stream.
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LangService = /** @class */ (function () {
                ...
                LangService.prototype.radio = function (lang) {
                    this.langClick.emit(lang);
                    this._lang = lang;
                };
                LangService.prototype.getLg = function () {
                    return this._lang;
                };
                return LangService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SidebarService = /** @class */ (function () {
                ...
                SidebarService.prototype.sidebar = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var SkilsService = /** @class */ (function () {
                function SkilsService(http) {
                    this.http = http;
                    this._engine = [];
                }
                SkilsService.prototype.getSkils = function () {
                    return this.http.get('assets/getSkils.JSON');
                };
                SkilsService.prototype.getSkilsProg = function () {
                    return this.http.get('assets/getSkilsProg.JSON');
                };
                return SkilsService;
            }());
            SkilsService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
